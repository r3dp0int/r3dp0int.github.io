...
date: 2020-10-30 08:00:00 -0600
categories: [Hack the Box, Writeup]
tags: [htb, hacking, hack the box, redteam, windows, iot, powershell, python, oscp, tj_null, easy, writeup, egre55, unfinished]     # TAG names should always be lowercase
show_image_post: true
image: /assets/img/0-omni-infocard.png
---
...
![](/assets/img/0-omni-infocard.png)
...
![](/assets/img/1-windows-device-portal.png)

![](/assets/img/2-auth-required.png)
...
![](/assets/img/3-loggin-in.png)

Logged in using `app`'s credentials.

![](/assets/img/4-windows-dive-portal.png)

Web portal for managing the IOT device

![](/assets/img/5-app-install.png)

Apps running on the device

![](/assets/img/6-interesting-processes.png)

Running Processes

![](/assets/img/7-another-password.png)

Found another password in the AllJoyn SoftAP settings

![](/assets/img/7-performance-monitor.png)

Device performance monitor

![](/assets/img/8-set-app.png)
...
![](/assets/img/10-administrator-logged-in.png)
...
![](/assets/img/11-hardening-txt.png)
...
If you like this content and would like to see more, please consider buying me a coffee! <a href="https://bmc.link/otsx"><img src="https://img.buymeacoffee.com/button-api/?text=Buy me a coffee&emoji=&slug=zweilosec&button_colour=FFDD00&font_colour=000000&font_family=Lato&outline_colour=000000&coffee_colour=ffffff"></a>